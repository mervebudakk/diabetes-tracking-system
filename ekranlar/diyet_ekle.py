...
class DiyetEklemeEkrani(QWidget):
    def __init__(self, hasta_id):
        ...
        # Diyet Türü
        self.lbl_tur = QLabel("Diyet Türü:", self)
        self.lbl_tur.move(20, 60)
        self.txt_tur = QLineEdit(self)
        self.txt_tur.setPlaceholderText("Örn: Karbonhidrat Azaltılmış")
    ...
    def diyet_kaydet(self):
        ...
        if not tur:
            QMessageBox.warning(self, "Uyarı", "Diyet türünü giriniz!")
            return
        ...
        try:
            ...
            cursor = conn.cursor()
            query = """
                INSERT INTO diyetler (hasta_id, tarih, tur, durum)
                VALUES (%s, %s, %s, %s)
            """
